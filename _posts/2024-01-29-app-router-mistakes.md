...
- Opinion
  - Next.js 앱 라우터를 사용하면서 겪을 수 있는 문제와 해결 방법을 제시해주다니, Vercel 팀은 매우매우 친절합니다. [Vercel 유튜브 채널](https://www.youtube.com/watch?v=RBM03RihZVs&t=3s){:target="\_blank"}에서도 추가 학습을 할 수 있었습니다. 앞으로는 공식 문서, 블로그를 살펴보아야겠습니다.
